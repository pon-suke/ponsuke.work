if (!self._FC2COUNTER89495020_0) {
  var _FC2COUNTER89495020_0 = {
    id: 89495020,
    graph_img: null,
    ...
    visit_info: function () {
      ...
      document.cookie = cookie_name + "=" + [version, is_unique ? now : info[1]].join("-") + " ; expires=" + time.toGMTString();
